  ...
  res.send(`
    ...
    <body class="bg-gray-900">
      ...
      <script type="text/babel">
        // Se utiliza un temporizador para garantizar que todos los scripts,
        // especialmente lucide-react, hayan tenido tiempo de cargarse por completo.
        setTimeout(() => {
          ...
          root.render(<App />);
        }, 500); // Esperamos 500ms para asegurar la carga completa de todos los scripts.
      </script>
    </body>
    </html>
  `);
